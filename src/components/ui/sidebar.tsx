    ...
    <div className="relative h-full flex-shrink-0">
      ...
      <button
        ...
        className="absolute -right-3 top-1/2 -translate-y-1/2 w-6 h-6 
                   ...
                   hover:bg-slate-700 hover:border-primary/50 
    ...
    <>
      ...
      >
        <div className="flex justify-end z-20 w-full">
          <Menu
            className="text-slate-200 cursor-pointer hover:text-primary transition-colors"
            onClick={() => setOpen(!open)}
          />
        </div>
        <AnimatePresence>
          {open && (
            ...
            >
              <div
                className="absolute right-10 top-10 z-50 text-slate-200 cursor-pointer hover:text-primary transition-colors"
                onClick={() => setOpen(!open)}
              >
                <X />
              </div>
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        isActive
          ? "bg-slate-800/80 text-primary shadow-lg shadow-black/20 ring-1 ring-slate-700/50"
